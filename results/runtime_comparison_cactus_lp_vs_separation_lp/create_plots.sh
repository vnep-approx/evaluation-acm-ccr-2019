...
#A plots folder will be created to store the plots.


python -m evaluation_acm_ccr_2019.cli evaluate_separation_vs_cactus_lp ifip_networking_2018_scenarios_seplp_dynvmp_results_reduced.pickle ifip_networking_2018_scenarios_cactus_lp_results_reduced.pickle  ./plots/ --output_filetype png 
move_logs_and_output log_plot_png

python -m evaluation_acm_ccr_2019.cli evaluate_separation_vs_cactus_lp ifip_networking_2018_scenarios_seplp_dynvmp_results_reduced.pickle ifip_networking_2018_scenarios_cactus_lp_results_reduced.pickle  ./plots/ --output_filetype pdf 
